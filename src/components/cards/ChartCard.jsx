...
//       {/* Chart */}
//       <div className="flex-1 w-full relative h-[260px] overflow-x-auto md:overflow-visible no-scrollbar">
//         {hasData ? (
//           <div
...
//                   ? `${Math.max((data?.length || 0) * 60, 600)}px`
//                   : "100%",
//             }}
//           >
//             {children}
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 w-full relative h-[260px] overflow-x-auto md:overflow-hidden no-scrollbar">
          {hasData ? (
            <div className="h-full w-full min-w-[600px] md:min-w-0">
              {children}
            </div>
          ) : (
            <div className="h-full flex items-center justify-center">
